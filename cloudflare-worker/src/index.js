  ...
  async fetch(request, env) {
    ...
    try {
      ...
      if (quotaHint(message)) {
        return new Response(JSON.stringify({ error: message, code: 'do-quota', fallback: 'p2p' }), { status: 503, headers: { ...cors, 'content-type': 'application/json' } });
      }
